...
void CFiguras::prisma (GLuint textura2)  //Funcion creacion prisma
{
...
void CFiguras::prisma2 (GLuint text)  //Funcion creacion prisma
{
...
void CFiguras::skybox(float altura, float largo, float profundidad, GLuint horizonte, GLuint suelo)  //Funcion creacion cielo
{
	...
	GLfloat vertice [8][3] = {
		...
		glBindTexture(GL_TEXTURE_2D, horizonte);   // choose the texture to use.
		//glBindTexture(GL_TEXTURE_2D, texture[filter]);   // choose the texture to use.
		glBegin(GL_POLYGON);	//Front
			//glColor3f(0.0,0.0,1.0);
			glNormal3f( 0.0f, 0.0f, -1.0f);
...
void CFiguras::prisma2t (float altura, float largo, float profundidad, GLuint pasto, GLuint borde)  //Funcion creacion prisma
{
	...
	GLfloat vertice [8][3] = {
		...
		glBindTexture(GL_TEXTURE_2D, borde);   // choose the texture to use.
		//glBindTexture(GL_TEXTURE_2D, texture[filter]);   // choose the texture to use.
		glBegin(GL_POLYGON);	//Front
			//glColor3f(0.0,0.0,1.0);
			glNormal3f( 0.0f, 0.0f, 1.0f);
		...
		glBindTexture(GL_TEXTURE_2D, pasto);   // choose the texture to use.
		glBegin(GL_POLYGON);  //Bottom
			//glColor3f(0.4,0.2,0.6);
			glNormal3f( 0.0f,-1.0f, 0.0f);
			glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[0]);
...
void CFiguras:: triangulo (float altura, float largo, float profundidad, GLuint pasto, GLuint borde)  //Funcion creacion prisma
{

	GLfloat vertice [6][3] = {
				{-0.5*largo ,0.5*altura, 0.5*profundidad},    //Coordenadas Vértice 0 
				{0.5*largo ,0.5*altura , 0.5*profundidad},    //Coordenadas Vértice 1 
				{0.5*largo ,-0.5*altura , 0.5*profundidad},    //Coordenadas Vértice 2 
				{-0.5*largo ,-0.5*altura , 0.5*profundidad},    //Coordenadas Vértice 3 
				{-0.5*largo ,0.5*altura , -0.5*profundidad},    //Coordenadas Vértice 4
				{-0.5*largo ,-0.5*altura , -0.5*profundidad},    //Coordenadas Vértice 5
				};
...
void CFiguras::prismaEdif (float altura, float largo, float profundidad, GLuint fachada)  //Funcion creacion prisma
{
	...
	GLfloat vertice [8][3] = {
		...
		glBindTexture(GL_TEXTURE_2D, fachada);   // choose the texture to use.
		//glBindTexture(GL_TEXTURE_2D, texture[filter]);   // choose the texture to use.
		glBegin(GL_POLYGON);	//Front
			//glColor3f(0.0,0.0,1.0);
			glNormal3f( 0.0f, 0.0f, 1.0f);
...
void CFiguras::prismaEst(GLuint text1, GLuint text2,GLuint text3, GLuint text4,GLuint text5, GLuint text6){
